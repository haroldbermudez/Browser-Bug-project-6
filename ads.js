/**
 * Created by mason.roberts491 on 11/30/16.
 */
var ELEMENT_ARRAY = [];
(function() {
...
function Element(element) {
    ...
    this.initialize = function() {
        ...
        this.element.style.left = this.element.getAttribute("data-x") || (Math.floor(window.innerWidth / 2) - Math.floor
            (this.getCSSValue(this.element, "width") / 1.3)) + "px";
